...
import amd_logo from './assets/amd_logo.jpg'
...
export const SkillsInfo = [
  ...
  export const experiences = [
    ...
    },  
    {
      ...
      desc: "• Contributing to the development of autonomous navigation and control software for the international Mars Rover competition, working with a multidisciplinary engineering team. • Implementing and testing ROS2-based software nodes for real-time sensing, motion control, and system integration across hardware subsystems.• Collaborating in a team-driven development environment, using Git/GitHub for version control, code reviews,and continuous integration practices.",
      skills: [ 
        "Linux",
        "Python",
        "C/C++", 
...
// 11 projects
  export const projects = [
    ...
    },
    {
      ...
      description:
        "This system scans an indoor environment by rotating a ToF sensor mounted on a stepper motor, capturing distance data, and transmitting it to a PC. Python scripts process the data and generate a 3D point cloud visualization of the scanned area.",
